...
# BENCHMARKS = ['WebGoat8','ruoyi','favorites-web','FEBS-auth','FEBS-system','FEBSShiro']
# BENCHMARKS = ['eladmin','newbee','opsli','shopizer']
# BENCHMARKS = ['jeesite']
BENCHMARKS = ['jeecg','SpringBlade','MCMS','WebGoat8']
