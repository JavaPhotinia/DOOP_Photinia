package org.clyze.doop.soot.Photinia.analysis;


import org.clyze.doop.soot.Photinia.backend.FrameworkModelingEngine;
import org.clyze.doop.soot.Photinia.backend.GenerateSyntheticClass;
import org.clyze.doop.soot.Photinia.backend.GenerateSyntheticClassImpl;
import org.clyze.doop.soot.Photinia.bean.*;
import org.clyze.doop.soot.Photinia.frontend.*;
import org.clyze.doop.soot.Photinia.transformer.BasicCoRTransformer;
import org.clyze.doop.soot.Photinia.transformer.DBAnalysis;
import org.clyze.doop.soot.Photinia.transformer.HandlerModelEnum;
import org.clyze.doop.soot.Photinia.transformer.SpringAnnotationTag;
import org.clyze.doop.soot.Photinia.utils.*;
import soot.*;
...
import static org.clyze.doop.soot.Photinia.frontend.AnnotationAnalysis.removeConfigurationsMethod;
import static org.clyze.doop.soot.Photinia.utils.StringConstantUtil.*;
...
public class CreateEdge {
    ...
    public void initCallGraph(List<String> inputs) {
        dataBaseDir.addAll(inputs);
        scanAllBeans();
        DAOPatternAnalysis();
        generateEntryPoints();
        initBean();
