package org.clyze.doop.soot.Photinia.bean;
...
public class InsertMethod {
    ...
    List<SootMethod> candidateSootMethod;
    ...
    public InsertMethod(SootMethod sootMethod, List<Integer> returnList, List<Integer> insertPointList, List<Integer> pjpList, List<SootMethod> candidateSootMethod) {
        this.sootMethod = sootMethod;
        this.returnList = returnList;
        this.insertPointList = insertPointList;
        this.pjpList = pjpList;
    ...
    public String toString() {
        return "InsertMethod{" +
                ...
                ", pjpList=" + pjpList +
                ", candidateSootMethod=" + candidateSootMethod +
                '}';
    }
}
