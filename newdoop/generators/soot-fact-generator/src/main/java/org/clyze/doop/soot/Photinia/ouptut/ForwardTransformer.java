package org.clyze.doop.soot.Photinia.ouptut;
        ...
        while (iterator.hasNext()) {
            ...
            try {
                if (edge.getSrc().method().toString().contains("com.salesmanager.")
                    ...
                    FileUtil.writeFile("/Users/cmiao/Documents/projects/code_analyse/Photinia/sootOutput/", "jeesite-cg.txt", jsonObject.toJSONString());
