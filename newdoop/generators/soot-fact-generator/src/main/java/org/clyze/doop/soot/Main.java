...
//// import org.clyze.doop.soot.pointans.analysis.CreateEdge;
...
public class Main {
    ...
    private static void invokeSoot(SootParameters sootParameters, Database db, Set<String> tmpDirs, SootData sootData, BasicJavaSupport_Soot java, AndroidSupport_Soot android, Scene scene, boolean writeFacts) throws DoopErrorCodeException, IOException {
        ...
        for (String lib : allLibs) {
            ...
            //FileUtil.preprocessSingleLib(lib);
        }
        ...
        Options.v().set_soot_classpath(String.join(File.pathSeparator, allLibs));
        FileUtil.preprocessLib(allLibs);
        Scene.v().addBasicClass("com.codahale.metrics.Gauge",HIERARCHY);
...
//        createEdge.initCallGraph("/root/newdoop/config.properties");
//        createEdge.initCallGraph(inputs);
