...
import org.clyze.doop.soot.Photinia.frontend.AnnotationAnalysis;
...
import org.clyze.doop.soot.Photinia.utils.XMLReadUtil;
...
public class DBAnalysis {
    ...
    private static final Map<SootClass, Document> mapXMLMap = findXMLFromJarfindXMLFromJar();
